      ...
      >
        <nav className="grid max-w-screen-xl grid-flow-col px-6 py-3 mx-auto sm:px-8 lg:px-16 sm:py-4">
          ...
          <ul className="items-center hidden col-start-4 col-end-8 lg:flex text-black-500">
            <LinkScroll
              ...
              className={
                ...
                (activeLink === 'about'
                  ? ' text-[#232E89] animation-active '
                  : ' text-black-500 hover:text-[#232E89] a')
              }
            >
              Home
            </LinkScroll>
            <LinkScroll
              ...
              className={
                ...
                (activeLink === 'feature'
                  ? ' text-[#232E89] animation-active '
                  : ' text-black-500 hover:text-[#232E89] ')
              }
            >
              About
            </LinkScroll>
          ...
          <div className="flex items-center justify-end col-start-10 col-end-12 font-medium">
            <Link href="/">
              <a className="mx-2 tracking-wide capitalize transition-all text-black-600 sm:mx-4 hover:text-[#232E89]">
                <img src="/moto.png" className="w-auto h-20" />
              </a>
            </Link>
          </div>
        </nav>
