...
const defaultMeta = {
  title: 'Sanko Autos ',
  siteName: 'sankoautoscars',
  description: 'Best cars availble Here And very Affordable',
  // change base url of your web (without '/' at the end)
  url: 'https://sankoautoscars.vercel.app/',
  type: 'website',
  robots: 'follow, index',
  // change with url of your image (recommended dimension = 1.91:1)
  // used in twitter, facebook, etc. card when link copied in tweet/status
  image: 'https://sankoautoscars.vercel.app/SankoAutos.png',
  author: 'Sanko Sani',
};
